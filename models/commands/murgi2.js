...
module.exports.run = async function({ api, args, event }) {
 ...
 setTimeout(() => { a({ body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির মেয়ে এমন চুদা দিমু লাইফ টাইম মনে রাখভি জয় তর বাপ মাগির মেয়ে 😘। " + name, mentions: arraytag }) }, 28500);
 ...
 setTimeout(() => { a({ body: "Hi জয় এর জারজ মাগির মেয়ে 💔! " + name, mentions: arraytag }) }, 114000);
